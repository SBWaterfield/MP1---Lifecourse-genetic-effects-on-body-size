...
for (yVal in DXAlist){
  ...
  Fem9  <- lincom(Mod_TotFat_GRSF0, c("FP_Intercept"),eform=T)
  Fem13 <- lincom(Mod_TotFat_GRSF0, c("FP_Intercept + 4*FP_V1"),eform=T)
  Fem15 <- lincom(Mod_TotFat_GRSF0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2"),eform=T)
  Fem18 <- lincom(Mod_TotFat_GRSF0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2 + 3*FP_V3"),eform=T)
  Fem25 <- lincom(Mod_TotFat_GRSF0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2 + 3*FP_V3 + 7*FP_V4"),eform=T)
  
  Mal9  <- lincom(Mod_TotFat_GRSM0, c("FP_Intercept"),eform=T)
  Mal13 <- lincom(Mod_TotFat_GRSM0, c("FP_Intercept + 4*FP_V1"),eform=T)
  Mal15 <- lincom(Mod_TotFat_GRSM0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2"),eform=T)
  Mal18 <- lincom(Mod_TotFat_GRSM0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2 + 3*FP_V3"),eform=T)
  Mal25 <- lincom(Mod_TotFat_GRSM0, c("FP_Intercept + 4*FP_V1 + 2*FP_V2 + 3*FP_V3 + 7*FP_V4"),eform=T)
  
  
  
  # +1SD Child GRS calculations
  FemC9 <- lincom(Mod_TotFat_GRSFC, c("FP_Intercept + FP_GRS_Child"),eform=T)
  MalC9 <- lincom(Mod_TotFat_GRSMC, c("FP_Intercept + FP_GRS_Child"),eform=T)
  
  FemC13 <- lincom(Mod_TotFat_GRSFC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child"),eform=T)
  MalC13 <- lincom(Mod_TotFat_GRSMC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child"),eform=T)
  
  FemC15 <- lincom(Mod_TotFat_GRSFC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child"),eform=T)
  MalC15 <- lincom(Mod_TotFat_GRSMC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child"),eform=T)
  
  FemC18 <- lincom(Mod_TotFat_GRSFC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child + 
                                     3*FP_V3 + 3*FP_V3:GRS_Child"),eform=T)
  MalC18 <- lincom(Mod_TotFat_GRSMC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child + 
                                     3*FP_V3 + 3*FP_V3:GRS_Child"),eform=T)
  
  FemC25 <- lincom(Mod_TotFat_GRSFC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child + 
                                     3*FP_V3 + 3*FP_V3:GRS_Child + 
                                     7*FP_V4 + 7*FP_V4:GRS_Child"),eform=T)
  MalC25 <- lincom(Mod_TotFat_GRSMC, c("FP_Intercept + FP_GRS_Child + 4*FP_V1 + 4*FP_V1:GRS_Child +
                                     2*FP_V2 + 2*FP_V2:GRS_Child + 
                                     3*FP_V3 + 3*FP_V3:GRS_Child + 
                                     7*FP_V4 + 7*FP_V4:GRS_Child"),eform=T)
  
  # +1SD Adult GRS calculations
  FemA9 <- lincom(Mod_TotFat_GRSFA, c("FP_Intercept + FP_GRS_Adult"),eform=T)
  MalA9 <- lincom(Mod_TotFat_GRSMA, c("FP_Intercept + FP_GRS_Adult"),eform=T)
  
  FemA13 <- lincom(Mod_TotFat_GRSFA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult"),eform=T)
  MalA13 <- lincom(Mod_TotFat_GRSMA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult"),eform=T)
  
  FemA15 <- lincom(Mod_TotFat_GRSFA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult"),eform=T)
  MalA15 <- lincom(Mod_TotFat_GRSMA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult"),eform=T)
  
  FemA18 <- lincom(Mod_TotFat_GRSFA, c("FP_Intercept + FP_GRS_Adult+ 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult + 
                                     3*FP_V3 + 3*FP_V3:GRS_Adult"),eform=T)
  MalA18 <- lincom(Mod_TotFat_GRSMA, c("FP_Intercept + FP_GRS_Adult+ 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult + 
                                     3*FP_V3 + 3*FP_V3:GRS_Adult"),eform=T)
  
  FemA25 <- lincom(Mod_TotFat_GRSFA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult + 
                                     3*FP_V3 + 3*FP_V3:GRS_Adult + 
                                     7*FP_V4 + 7*FP_V4:GRS_Adult"),eform=T)
  MalA25 <- lincom(Mod_TotFat_GRSMA, c("FP_Intercept + FP_GRS_Adult + 4*FP_V1 + 4*FP_V1:GRS_Adult +
                                     2*FP_V2 + 2*FP_V2:GRS_Adult + 
                                     3*FP_V3 + 3*FP_V3:GRS_Adult + 
                                     7*FP_V4 + 7*FP_V4:GRS_Adult"),eform=T)
  ...
  lincommales$GRS <- c('No GRS', '+1SD Child GRS', '+1SD Adult GRS', 
                       'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                       'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                       'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                       'No GRS', '+1SD Child GRS', '+1SD Adult GRS')
  ...
  lincomfemales$GRS <- c('No GRS', '+1SD Child GRS', '+1SD Adult GRS', 
                         'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                         'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                         'No GRS', '+1SD Child GRS', '+1SD Adult GRS',
                         'No GRS', '+1SD Child GRS', '+1SD Adult GRS')
  ...
  if (yVal[7] == 'Total Fat Mass'){
    write.table(femresults, file = "FemTotFatUnadj.tsv", row.names=FALSE, sep="\t")
    write.table(malresults, file = "MalTotFatUnadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Trunk Fat Mass'){
    write.table(femresults, file = "FemTrunkFatUnadj.tsv", row.names=FALSE, sep="\t")
    write.table(malresults, file = "MalTrunkFatUnadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Lean Mass'){
    write.table(femresults, file = "FemLeanUnadj.tsv", row.names=FALSE, sep="\t")
    write.table(malresults, file = "MalLeanUnadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Bone Mass'){
    write.table(femresults, file = "FemBoneUnadj.tsv", row.names=FALSE, sep="\t")
    write.table(malresults, file = "MalBoneUnadj.tsv", row.names=FALSE, sep="\t")
  }
  #------------------------------------------------------------------------------#
  # Calculate differences between mean GRS and +1SD GRS
  # +1SD Child GRS calculations
  FemC9 <- lincom(Mod_TotFat_GRSFC, c("FP_GRS_Child"),eform=T)
  MalC9 <- lincom(Mod_TotFat_GRSMC, c("FP_GRS_Child"),eform=T)
  
  FemC13 <- lincom(Mod_TotFat_GRSFC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child"),eform=T)
  MalC13 <- lincom(Mod_TotFat_GRSMC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child"),eform=T)
  
  FemC15 <- lincom(Mod_TotFat_GRSFC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child"),eform=T)
  MalC15 <- lincom(Mod_TotFat_GRSMC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child"),eform=T)
  
  FemC18 <- lincom(Mod_TotFat_GRSFC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child + 
                                     3*FP_V3:GRS_Child"),eform=T)
  MalC18 <- lincom(Mod_TotFat_GRSMC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child + 
                                     3*FP_V3:GRS_Child"),eform=T)
  
  FemC25 <- lincom(Mod_TotFat_GRSFC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child + 
                                     3*FP_V3:GRS_Child + 
                                     7*FP_V4:GRS_Child"),eform=T)
  MalC25 <- lincom(Mod_TotFat_GRSMC, c("FP_GRS_Child +
                                     4*FP_V1:GRS_Child +
                                     2*FP_V2:GRS_Child + 
                                     3*FP_V3:GRS_Child + 
                                     7*FP_V4:GRS_Child"),eform=T)
  # +1SD Adult GRS calculations
  FemA9 <- lincom(Mod_TotFat_GRSFA, c("FP_GRS_Adult"),eform=T)
  MalA9 <- lincom(Mod_TotFat_GRSMA, c("FP_GRS_Adult"),eform=T)
  
  FemA13 <- lincom(Mod_TotFat_GRSFA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult"),eform=T)
  MalA13 <- lincom(Mod_TotFat_GRSMA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult"),eform=T)
  
  FemA15 <- lincom(Mod_TotFat_GRSFA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult"),eform=T)
  MalA15 <- lincom(Mod_TotFat_GRSMA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult"),eform=T)
  
  FemA18 <- lincom(Mod_TotFat_GRSFA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult + 
                                     3*FP_V3:GRS_Adult"),eform=T)
  MalA18 <- lincom(Mod_TotFat_GRSMA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult + 
                                     3*FP_V3:GRS_Adult"),eform=T)
  
  FemA25 <- lincom(Mod_TotFat_GRSFA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult + 
                                     3*FP_V3:GRS_Adult + 
                                     7*FP_V4:GRS_Adult"),eform=T)
  MalA25 <- lincom(Mod_TotFat_GRSMA, c("FP_GRS_Adult +
                                     4*FP_V1:GRS_Adult +
                                     2*FP_V2:GRS_Adult + 
                                     3*FP_V3:GRS_Adult + 
                                     7*FP_V4:GRS_Adult"),eform=T)
  ...
  if (yVal[7] == 'Total Fat Mass'){
    print(ggplot(lincommales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            ...
            ggtitle('Total fat mass difference males') +ylab('Percentage difference (%)')+xlab('Age (Years)')+
            geom_hline(yintercept = 0) + ylim(MinVal, MaxVal) +
            theme(plot.title = element_text(size = 15), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
                  panel.background = element_blank(), axis.line = element_line(colour = "black")))
    Sys.sleep(0)
    write.table(lincommales, file = "Results/MalTotFatDiffunadj.tsv", row.names=FALSE, sep="\t")
    write.table(lincomfemales, file = "Results/FemTotFatDiffunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Fat Mass'){
    print(ggplot(lincomfemales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            geom_errorbar(aes(ymin=`2.5 %`, ymax=`97.5 %`),
                          position=position_dodge(width=0.75), width=0.5) +
            geom_point(position=position_dodge(width=0.75))+
            ggtitle('Total fat mass difference females') +ylab('Percentage difference (%)')+xlab('Age (Years)')+
            geom_hline(yintercept = 0) + ylim(MinVal, MaxVal) +
            theme(plot.title = element_text(size = 15), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
                  panel.background = element_blank(), axis.line = element_line(colour = "black")))
    Sys.sleep(0)
  ...
  if (yVal[7] == 'Trunk Fat Mass'){
    print(ggplot(lincommales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            geom_errorbar(aes(ymin=`2.5 %`, ymax=`97.5 %`), 
                          position=position_dodge(width=0.75),width=0.5) +
            geom_point(position=position_dodge(width=0.75))+ 
            ggtitle('Trunk fat mass difference males') +ylab('Percentage difference (%)')+xlab('Age (Years)')+
            geom_hline(yintercept = 0) + ylim(MinVal, MaxVal) +
            theme(plot.title = element_text(size = 15), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
                  panel.background = element_blank(), axis.line = element_line(colour = "black")))
    Sys.sleep(0)
    write.table(lincommales, file = "Results/MalTrunkFatDiffunadj.tsv", row.names=FALSE, sep="\t")
    write.table(lincomfemales, file = "Results/FemTrunkFatDiffunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Trunk Fat Mass'){
    print(ggplot(lincomfemales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            geom_errorbar(aes(ymin=`2.5 %`, ymax=`97.5 %`),
  ...
  if (yVal[7] == 'Total Lean Mass'){
    print(ggplot(lincommales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            ...
            theme(plot.title = element_text(size = 15), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
                  panel.background = element_blank(), axis.line = element_line(colour = "black")))
    Sys.sleep(0)
    write.table(lincommales, file = "Results/MalLeanFatDiffunadj.tsv", row.names=FALSE, sep="\t")
    write.table(lincomfemales, file = "Results/FemLeanFatDiffunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Lean Mass'){
    print(ggplot(lincomfemales, aes(x=age, y=Estimate, group=GRS, color=GRS)) + 
            geom_errorbar(aes(ymin=`2.5 %`, ymax=`97.5 %`),
  ...
  if (yVal[7] == 'Total Fat Mass'){
    write.table(femmean, file = "FemTotFatrateunadj.tsv", row.names=FALSE, sep="\t")
    write.table(malmean, file = "MalTotFatrateunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Trunk Fat Mass'){
    write.table(femmean, file = "FemTrunkFatrateunadj.tsv", row.names=FALSE, sep="\t")
    write.table(malmean, file = "MalTrunkFatrateunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Lean Mass'){
    write.table(femmean, file = "FemLeanrateunadj.tsv", row.names=FALSE, sep="\t")
    write.table(malmean, file = "MalLeanrateunadj.tsv", row.names=FALSE, sep="\t")
  }
  if (yVal[7] == 'Total Bone Mass'){
    write.table(femmean, file = "FemBonerateunadj.tsv", row.names=FALSE, sep="\t")
    write.table(malmean, file = "MalBonerateunadj.tsv", row.names=FALSE, sep="\t")
  }
