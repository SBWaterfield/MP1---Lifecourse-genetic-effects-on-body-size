...
load("C:/Users/gv20022/OneDrive - University of Bristol/Desktop/MP1/ALSPACSingleSNPSexCombo.Rdata")
...
SNPList <- RichardsonSNPCombo$SNPlistCombo
...
# 
 save(MalTotFat_SNP, MalTotFatDiff_SNP, FemTotFat_SNP, FemTotFatDiff_SNP,
      ...
      file = 'SingleSNP_ResultsSexCombo.RData')
