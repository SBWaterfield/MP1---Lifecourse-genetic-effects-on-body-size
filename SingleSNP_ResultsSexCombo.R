...
FemIntersect <- intersect(SNPs_ComboChild$SNP, SNPs_ComboAdult$SNP)
MalIntersect <- intersect(SNPs_ComboChild$SNP, SNPs_ComboAdult$SNP)
...
FemChildLeanDiff_SNP <- FemLeanDiff_SNP[FemLeanDiff_SNP$SNP %in% SNPs_ComboChild$SNP,]
FemAdultLeanDiff_SNP <- FemLeanDiff_SNP[FemLeanDiff_SNP$SNP %in% SNPs_ComboAdult$SNP,]
FemChildTotFatDiff_SNP <- FemTotFatDiff_SNP[FemTotFatDiff_SNP$SNP %in% SNPs_ComboChild$SNP,]
FemAdultTotFatDiff_SNP <- FemTotFatDiff_SNP[FemTotFatDiff_SNP$SNP %in% SNPs_ComboAdult$SNP,]

MalChildLeanDiff_SNP <- MalLeanDiff_SNP[MalLeanDiff_SNP$SNP %in% SNPs_ComboChild$SNP,]
MalAdultLeanDiff_SNP <- MalLeanDiff_SNP[MalLeanDiff_SNP$SNP %in% SNPs_ComboAdult$SNP,]
MalChildTotFatDiff_SNP <- MalTotFatDiff_SNP[MalTotFatDiff_SNP$SNP %in% SNPs_ComboChild$SNP,]
MalAdultTotFatDiff_SNP <- MalTotFatDiff_SNP[MalTotFatDiff_SNP$SNP %in% SNPs_ComboAdult$SNP,]
...
FemChildLeanDiff_SNP <- FemChildLeanDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
FemAdultLeanDiff_SNP <- FemAdultLeanDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
FemChildTotFatDiff_SNP <- FemChildTotFatDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
FemAdultTotFatDiff_SNP <- FemAdultTotFatDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
MalChildLeanDiff_SNP <- MalChildLeanDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
MalAdultLeanDiff_SNP <- MalAdultLeanDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
MalChildTotFatDiff_SNP <- MalChildTotFatDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))
MalAdultTotFatDiff_SNP <- MalAdultTotFatDiff_SNP %>% dplyr::select('age', 'SNP', '+SNP') %>% reshape(idvar = "SNP", timevar = "age", sep = "", direction = "wide", varying = c('Age9', 'Age13', 'Age15', 'Age18', 'Age25'))

#Add in Annotation
FemChildLeanDiff_SNP <- merge(FemChildLeanDiff_SNP, SNPs_ComboChild[, c("SNP", "Closest gene")], by="SNP")
FemChildTotFatDiff_SNP <- merge(FemChildTotFatDiff_SNP, SNPs_ComboChild[, c("SNP", "Closest gene")], by="SNP")
MalChildLeanDiff_SNP <- merge(MalChildLeanDiff_SNP, SNPs_ComboChild[, c("SNP", "Closest gene")], by="SNP")
MalChildTotFatDiff_SNP <- merge(MalChildTotFatDiff_SNP, SNPs_ComboChild[, c("SNP", "Closest gene")], by="SNP")
FemAdultLeanDiff_SNP <- merge(FemAdultLeanDiff_SNP, SNPs_ComboAdult[, c("SNP", "Closest gene")], by="SNP")
FemAdultTotFatDiff_SNP <- merge(FemAdultTotFatDiff_SNP, SNPs_ComboAdult[, c("SNP", "Closest gene")], by="SNP")
MalAdultLeanDiff_SNP <- merge(MalAdultLeanDiff_SNP, SNPs_ComboAdult[, c("SNP", "Closest gene")], by="SNP")
MalAdultTotFatDiff_SNP <- merge(MalAdultTotFatDiff_SNP, SNPs_ComboAdult[, c("SNP", "Closest gene")], by="SNP")

#EXport to CSV
write.csv(FemChildTotFatDiff_SNP, row.names = F, file = 'FemchildTotFatDiff_SNPCombo.csv')
write.csv(FemAdultTotFatDiff_SNP, row.names = F, file = 'FemAdultTotFatDiff_SNPCombo.csv')
write.csv(FemChildLeanDiff_SNP, row.names = F, file = 'FemchildLeanDiff_SNPCombo.csv')
write.csv(FemAdultLeanDiff_SNP, row.names = F, file = 'FemAdultLeanDiff_SNPCombo.csv')
write.csv(MalChildTotFatDiff_SNP, row.names = F, file = 'MalchildTotFatDiff_SNPCombo.csv')
write.csv(MalAdultTotFatDiff_SNP, row.names = F, file = 'MalAdultTotFatDiff_SNPCombo.csv')
write.csv(MalChildLeanDiff_SNP, row.names = F, file = 'MalchildLeanDiff_SNPCombo.csv')
write.csv(MalAdultLeanDiff_SNP, row.names = F, file = 'MalAdultLeanDiff_SNPCombo.csv')

# Clean up workspace
rm(SNPs_ComboChild, SNPs_ComboChild, SNPs_ComboChild, SNPs_ComboChild, 
...
sum(FemChildTotFatDiff_SNP$TrueEffect) #
sum(FemAdultTotFatDiff_SNP$TrueEffect) #
sum(MalChildTotFatDiff_SNP$TrueEffect) #
sum(MalAdultTotFatDiff_SNP$TrueEffect) #
length(unique(FemChildTotFatDiff_SNP[FemChildTotFatDiff_SNP$TrueEffect==T,]$SNP)) #
length(unique(FemAdultTotFatDiff_SNP[FemAdultTotFatDiff_SNP$TrueEffect==T,]$SNP)) #
length(unique(MalChildTotFatDiff_SNP[MalChildTotFatDiff_SNP$TrueEffect==T,]$SNP)) #
length(unique(MalAdultTotFatDiff_SNP[MalAdultTotFatDiff_SNP$TrueEffect==T,]$SNP)) #
